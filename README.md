...
This is a quick lab on how to use github which is service where projects like this lab and coding programs could be uploaded and shared with others. Almost like a cloud service similar to google drive, dropbox. It is just a quick demo lab I made to create a repository from the cli on my Linux machine which would be loaded into github automatically. 
